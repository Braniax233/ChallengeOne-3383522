    ...
    >
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-3xl font-bold text-ink-900 mt-1 leading-none">
            {value ?? "—"}
          </p>
          {subtitle && (
        ...
        <div className="border-t border-ink-100 pt-3 space-y-2">
          {sub1Label && (
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-semibold text-ink-800">{sub1Value ?? "—"}</span>
            </div>
          )}
          {sub2Label && (
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-semibold text-ink-800">{sub2Value ?? "—"}</span>
            </div>
          )}
        </div>
      )}
